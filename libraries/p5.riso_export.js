...
function halftoneImage(img, shape, frequency, angle, intensity) {
  ...
  let patternFunction = typeof shape === "function" ? shape : halftonePatterns[shape];
...
export {Riso, ditherImage, clearRiso, drawRiso, lookupTable, halftoneImage, exportRiso, extractCMYKChannel, extractRGBChannel, risoNoFill, risoNoStroke, rgb2cmyk, RISOCOLORS}